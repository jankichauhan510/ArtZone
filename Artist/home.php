...
<body>
    <nav>
        ...
        <ul>
            ...
            <li class="pic"><a href="profile.php" class="pic"><?php echo $fname . " " . $lname ?></a></li>
        ...
        ?>
                <div class="card  " style="background-color: mediumpurple;">
                    ...
                    <div class="content">
                        ...
                        <button type="submit"><a href="display.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;color: white;" >Explore Me!</a></button>
                        <!--<button type="submit" onclick="openpopup()"><a href="display.php" style="text-decoration: none;color: white;" >Explore Me!</a></button>-->
                    </div>
                </div>
