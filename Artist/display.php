...
$id= $_GET['id'];
$findresult = mysqli_query($dbc, "SELECT * FROM artist WHERE id = $id ");
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>My Artistry</h2>
       ...
       <div class="card text-white bg-info mb-3" style="width: 18rem; box-shadow: 0px 1px 36px 5px rgba(0, 0, 0, 0.28); border-radius: 5px; border: 0.5px solid mediumpurple; margin:10px;">
